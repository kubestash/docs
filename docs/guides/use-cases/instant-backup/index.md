...
>**Note:** YAML files used in this tutorial are stored in  [docs/guides/use-cases/instant-backup/examples](/docs/guides/use-cases/instant-backup/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
