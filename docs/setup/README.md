...
<div style="text-align: center;">
  <a class="button is-info is-medium is-active has-text-weight-normal" href="/docs/setup/install/kubestash/"  style="background:#FC6011; width: 18rem;">Install KubeStash</a>
</div>
<br>
...
- **Install KubeStash:** Installation instructions for KubeStash and its various components.
  - [KubeStash operator](/docs/setup/install/kubestash/): Installation instructions for KubeStash operator.
